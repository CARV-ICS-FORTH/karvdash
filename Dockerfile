...
RUN if [ "${TARGETARCH}" == "amd64" ]; then \\
    curl -Lo /tmp/go-containerregistry.tar.gz https://github.com/google/go-containerregistry/releases/download/${GO_CONTAINERREGISTRY_VERSION}/go-containerregistry_Linux_x64_64.tar.gz; \\
    else \\
